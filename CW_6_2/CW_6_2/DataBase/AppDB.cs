...
namespace CW_6_2.DataBase
{
    public class AppDB
    {
        ...
        {
            new Employee{Id=123,FName="hasan",LName="kushkaki",NationalCode=123456789,Gender=1,Mobile = 912345678,Email="hasan@kushkaki.com"},
            new Employee{Id=1234,FName="sara",LName="hoseini",NationalCode=125678908,Gender=0,Mobile =912358364,Email="sara@hoseini.com"},
