...
namespace CW_6_2.DataBase
{
    public class AppDB
    {
        ...
        public List<Salary> salarys = new List<Salary>()
        {
            ...
            new Salary{Id=3,Amount=8,EmployeeId=123,Tax=1,OtherBenefit=2,Year=1391,Month=1},
            new Salary{Id=4,Amount=8,EmployeeId=123,Tax=1,OtherBenefit=2,Year=1392,Month=1},
            new Salary{Id=5,Amount=8,EmployeeId=123,Tax=1,OtherBenefit=2,Year=1393,Month=1},
            new Salary{Id=6,Amount=8,EmployeeId=123,Tax=1,OtherBenefit=2,Year=1394,Month=1},
